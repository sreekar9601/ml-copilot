#!/usr/bin/env python3
"""Simplified enhanced ingestion for testing."""
...
async def run_simple_enhanced_ingestion():
    """Run enhanced ingestion with simplified approach."""
    
    logger.info("🚀 Starting simplified enhanced ingestion...")
...
if __name__ == "__main__":
    asyncio.run(run_simple_enhanced_ingestion())
